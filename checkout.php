...
echo "		<div class=\"select_title type_2 r_corners relative color_dark mw_0\">Choose Title</div>\n"; 
echo "			<ul class=\"select_list d_none\"></ul>\n"; 
echo "				<select name=\"title\">\n"; 
echo "					<option selected=\"selected\" value=\"Mr\">Mr</option>\n"; 
echo "					<option value=\"Ms\">Ms</option>\n"; 
echo "				</select>\n"; 
echo "		</div>\n"; 
echo "			</li>\n"; 
echo "		<li class=\"m_bottom_15\">\n"; 
echo "<label for=\"f_name_1\" class=\"d_inline_b m_bottom_5 required\">Name</label>\n"; 
echo "<input type=\"text\" id=\"f_name_1\" name=\"name\" class=\"r_corners full_width\">\n"; 
echo "		</li>\n"; 
echo "												<li class=\"m_bottom_15\">\n"; 
echo "													<label for=\"address_1\" class=\"d_inline_b m_bottom_5 required\">Address 1</label>\n"; 
echo "													<input type=\"text\" id=\"address_1\" name=\"addr1\" class=\"r_corners full_width\">\n"; 
echo "												</li>\n"; 
echo "												<li class=\"m_bottom_15\">\n"; 
echo "													<label for=\"address_1_1\" class=\"d_inline_b m_bottom_5 required\">Address 2</label>\n"; 
echo "													<input type=\"text\" id=\"address_1_1\" name=\"addr2\" class=\"r_corners full_width\">\n"; 
echo "												</li>\n"; 
echo "												<li class=\"m_bottom_15\">\n"; 
echo "													<label for=\"code_1\" class=\"d_inline_b m_bottom_5 required\">Zip / Postal Code</label>\n"; 
echo "													<input type=\"text\" id=\"code_1\" name=\"pin\" class=\"r_corners full_width\">\n"; 
echo "												</li>\n"; 
echo "												<li class=\"m_bottom_15\">\n"; 
echo "													<label for=\"city_1\" class=\"d_inline_b m_bottom_5 required\">City</label>\n"; 
echo "													<input type=\"text\" id=\"city_1\" name=\"city\" class=\"r_corners full_width\">\n"; 
echo "												</li>\n"; 
echo "												<li class=\"m_bottom_15\">\n"; 
...
echo "							<option value=\"Gova\">Gova</option>\n"; 
...
echo "							<option value=\"Orissa\">Orissa</option>\n"; 
...
echo "													<input type=\"text\" id=\"m_phone_1\" name=\"phone\" class=\"r_corners full_width\">\n"; 
echo "												</li>\n"; 							
echo "											</ul>\n"; 
echo "										\n"; 
echo "									</div>\n"; 
...
echo "								<tr>\n"; 
echo "									<td colspan=\"2\">\n"; 
echo "										<button name=\"placeorder\"class=\"button_type_6 bg_scheme_color f_size_large r_corners tr_all_hover color_light m_bottom_20\">Confirm Purchase</button>\n"; 
echo "									</td>\n"; 
echo "									</form>\n"; 
echo "								</tr>\n"; 
echo "							</table>\n";
