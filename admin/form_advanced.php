    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var cb = function (start, end, label) {
                ...
                $('#reportrange_right span').php(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));
            ...
            $('#reportrange_right span').php(moment().subtract(29, 'days').format('MMMM D, YYYY') + ' - ' + moment().format('MMMM D, YYYY'));
