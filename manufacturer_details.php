...
<!--[if (gt IE 9)|!(IE)]><!--><html lang="en"><!--<![endif]-->
	<head>
		<title>Flatastic - Manufacturer Details</title>
		<meta charset="utf-8">
			...
			<section class="breadcrumbs">
				<div class="container">
					<ul class="horizontal_list clearfix bc_list f_size_medium">
						...
						<li class="m_right_10 current"><a href="#" class="default_t_color">Manufacturers<i class="fa fa-angle-right d_inline_middle m_left_10"></i></a></li>
						<li><a href="#" class="default_t_color">Manufacturer Name 1</a></li>
					</ul>
				</div>
			</section>
			<!--content-->
				...
				<div class="container">
					<div class="row clearfix">
						...
						<section class="col-lg-9 col-md-9 col-sm-9 m_xs_bottom_30">
							<h2 class="tt_uppercase color_dark m_bottom_30">Manufacturer Name 1</h2>
							<div class="bg_light_color_3 r_corners shadow manufacturers">
								<img class="f_left m_right_20 m_sm_bottom_5" src="images/brand_logo_type_2.jpg" alt="">
