...
<!--[if (gt IE 9)|!(IE)]><!--><html lang="en"><!--<![endif]-->
	<head>
		<title>Flatastic - Manufacturers</title>
		<meta charset="utf-8">
							...
							<div class="bg_light_color_3 r_corners shadow manufacturers t_xs_align_c">
								<div class="row clearfix m_bottom_25 m_xs_bottom_0">
									<figure class="col-lg-3 col-md-3 col-sm-3 col-xs-6 m_xs_bottom_15">
										<a href="manufacturer_details.php" class="m_image_wrap d_block m_bottom_15 d_xs_inline_b d_mxs_block">
											<img src="images/brand_logo_type_2.jpg" alt="">
										</a>
										<figcaption>
											<h5><a href="manufacturer_details.php" class="color_dark fw_medium">Manufacturer Name 1</a></h5>
										</figcaption>
									</figure>
									<figure class="col-lg-3 col-md-3 col-sm-3 col-xs-6 m_xs_bottom_15">
										<a href="manufacturer_details.php" class="m_image_wrap d_block m_bottom_15 d_xs_inline_b d_mxs_block">
										...
										<figcaption>
											<h5><a href="manufacturer_details.php" class="color_dark fw_medium">Manufacturer Name 2</a></h5>
										</figcaption>
									</figure>
									<figure class="col-lg-3 col-md-3 col-sm-3 col-xs-6 m_xs_bottom_15">
										<a href="manufacturer_details.php" class="m_image_wrap d_block m_bottom_15 d_xs_inline_b d_mxs_block">
										...
										<figcaption>
											<h5><a href="manufacturer_details.php" class="color_dark fw_medium">Manufacturer Name 3</a></h5>
										</figcaption>
									</figure>
									<figure class="col-lg-3 col-md-3 col-sm-3 col-xs-6 m_xs_bottom_15">
										<a href="manufacturer_details.php" class="m_image_wrap d_block m_bottom_15 d_xs_inline_b d_mxs_block">
										...
										<figcaption>
											<h5><a href="manufacturer_details.php" class="color_dark fw_medium">Manufacturer Name 4</a></h5>
										</figcaption>
									</figure>
								</div>
								<div class="row clearfix">
									<figure class="col-lg-3 col-md-3 col-sm-3 col-xs-6 m_xs_bottom_15">
										...
										<figcaption>
											<h5><a href="manufacturer_details.php" class="color_dark fw_medium">Manufacturer Name 5</a></h5>
										</figcaption>
									</figure>
									<figure class="col-lg-3 col-md-3 col-sm-3 col-xs-6 m_xs_bottom_15">
										<a href="manufacturer_details.php" class="m_image_wrap d_block m_bottom_15 d_xs_inline_b d_mxs_block">
										...
										<figcaption>
											<h5><a href="manufacturer_details.php" class="color_dark fw_medium">Manufacturer Name 6</a></h5>
										</figcaption>
									</figure>
									<figure class="col-lg-3 col-md-3 col-sm-3 col-xs-6 m_xs_bottom_15">
										<a href="manufacturer_details.php" class="m_image_wrap d_block m_bottom_15 d_xs_inline_b d_mxs_block">
										...
										<figcaption>
											<h5><a href="manufacturer_details.php" class="color_dark fw_medium">Manufacturer Name 7</a></h5>
										</figcaption>
									</figure>
									<figure class="col-lg-3 col-md-3 col-sm-3 col-xs-6 m_xs_bottom_15">
										<a href="manufacturer_details.php" class="m_image_wrap d_block m_bottom_15 d_xs_inline_b d_mxs_block">
										...
										<figcaption>
											<h5><a href="manufacturer_details.php" class="color_dark fw_medium">Manufacturer Name 8</a></h5>
										</figcaption>
									</figure>
								</div>
							</div>
