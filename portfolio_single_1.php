...
<!--[if (gt IE 9)|!(IE)]><!--><html lang="en"><!--<![endif]-->
	<head>
		<title>Flatastic - Single Portfolio Post v1</title>
		<meta charset="utf-8">
			...
			<section class="breadcrumbs">
				<div class="container">
					<ul class="horizontal_list clearfix bc_list f_size_medium">
						...
						<li><a href="#" class="default_t_color">Single Portfolio Post v1</a></li>
					</ul>
				</div>
			</section>
			<!--content-->
				...
				<div class="container">
					<div class="d_table full_width d_xs_block m_bottom_25">
						<div class="d_table_cell v_align_m d_xs_block m_xs_bottom_15">
							<h2 class="tt_uppercase color_dark">Single Portfolio Post v1</h2>
						</div>
					...
					<div class="row clearfix">
						<section class="col-lg-8 col-md-8 col-sm-8">
							<div class="photoframe r_corners shadow wrapper m_bottom_30">
								<img src="images/portfolio_img_37.jpg" alt="" class="tr_all_long_hover">
							</div>
							<div class="photoframe r_corners shadow wrapper m_bottom_30">
								<img src="images/portfolio_img_38.jpg" alt="" class="tr_all_long_hover">
							</div>
