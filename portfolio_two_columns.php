...
<!--[if (gt IE 9)|!(IE)]><!--><html lang="en"><!--<![endif]-->
	<head>
		<title>Flatastic - Portfolio 2 Columns</title>
		<meta charset="utf-8">
					...
					<div class="container clearfix">
						...
						<nav role="navigation" class="f_left f_xs_none d_xs_none">	
							<ul class="horizontal_list main_menu clearfix">
								...
								<li class="relative current f_xs_none m_xs_bottom_5"><a href="#" class="tr_delay_hover color_light tt_uppercase"><b>Portfolio</b></a>
									<!--sub menu-->
									<div class="sub_menu_wrap top_arrow d_xs_none type_2 tr_all_hover clearfix r_corners">
										<ul class="sub_menu">
			...
			<section class="breadcrumbs">
				<div class="container">
					<ul class="horizontal_list clearfix bc_list f_size_medium">
						...
						<li><a href="#" class="default_t_color">2 Column Portfolio</a></li>
					</ul>
				</div>
			</section>
			<!--content-->
				...
				<div class="container">
					<div class="d_table full_width d_xs_block">
						<div class="d_table_cell v_align_m d_xs_block m_xs_bottom_15">
							<h2 class="tt_uppercase color_dark">2 Column Portfolio</h2>
						</div>
					...
					<!--portfolio isotope-->
					<section class="portfolio_isotope_container two_columns">
						<div class="portfolio_item t_xs_align_c portraits">
							<figure class="d_xs_inline_b d_mxs_block">
								<div class="photoframe with_buttons relative shadow r_corners wrapper m_bottom_15">
									<img src="images/portfolio_img_01.jpg" alt="" class="tr_all_long_hover">
						...
						<div class="portfolio_item t_xs_align_c fashion">
							<figure class="d_xs_inline_b d_mxs_block">
								<div class="photoframe with_buttons relative shadow r_corners wrapper m_bottom_15">
									<img src="images/portfolio_img_02.jpg" alt="" class="tr_all_long_hover">
									<div class="open_buttons clearfix">
						...
						<div class="portfolio_item t_xs_align_c people">
							<figure class="d_xs_inline_b d_mxs_block">
								<div class="photoframe with_buttons relative shadow r_corners wrapper m_bottom_15">
									<img src="images/portfolio_img_03.jpg" alt="" class="tr_all_long_hover">
									<div class="open_buttons clearfix">
						...
						<div class="portfolio_item t_xs_align_c people">
							<figure class="d_xs_inline_b d_mxs_block">
								<div class="photoframe with_buttons relative shadow r_corners wrapper m_bottom_15">
									<img src="images/portfolio_img_04.jpg" alt="" class="tr_all_long_hover">
									<div class="open_buttons clearfix">
						...
						<div class="portfolio_item t_xs_align_c cities">
							<figure class="d_xs_inline_b d_mxs_block">
								<div class="photoframe with_buttons relative shadow r_corners wrapper m_bottom_15">
									<img src="images/portfolio_img_05.jpg" alt="" class="tr_all_long_hover">
									<div class="open_buttons clearfix">
						...
						<div class="portfolio_item t_xs_align_c people">
							<figure class="d_xs_inline_b d_mxs_block">
								<div class="photoframe with_buttons relative shadow r_corners wrapper m_bottom_15">
									<img src="images/portfolio_img_06.jpg" alt="" class="tr_all_long_hover">
									<div class="open_buttons clearfix">
