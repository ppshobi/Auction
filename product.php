...
<!--[if (gt IE 9)|!(IE)]><!--><html lang="en"><!--<![endif]-->
	<head>
		<title>Online Auction - Product Page Sidebar</title>
		<meta charset="utf-8">
			...
			<footer id="footer">
				...
				<div class="footer_bottom_part">
					<div class="container clearfix t_mxs_align_c">
						<p class="f_left f_mxs_none m_mxs_bottom_10">&copy; 2016 <span class="color_light">Online Auction</span>. All Rights Reserved.</p>
