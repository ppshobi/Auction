...
<!--[if (gt IE 9)|!(IE)]><!--><html lang="en"><!--<![endif]-->
	<head>
		<title>Flatastic - Single Portfolio Post v2</title>
		<meta charset="utf-8">
	...
	<body>
		...
		<div class="wide_layout relative">
			...
			<section class="breadcrumbs">
				<div class="container">
					<ul class="horizontal_list clearfix bc_list f_size_medium">
						...
						<li><a href="#" class="default_t_color">Single Portfolio Post v2</a></li>
					</ul>
				</div>
			</section>
			<!--slider-->
			<div class="flexslider portfolio">
				<ul class="slides">
					<li>
						<img src="images/portfolio_img_40.jpg" alt="" data-custom-thumb="images/portfolio_img_41.jpg">
					</li>
					<li>
						<img src="images/portfolio_img_41.jpg" alt="" data-custom-thumb="images/portfolio_img_42.jpg">
					</li>
					<li>
						<img src="images/portfolio_img_42.jpg" alt="" data-custom-thumb="images/portfolio_img_40.jpg">
					</li>
				</ul>
			</div>
			<!--content-->
				...
				<div class="container">
					<div class="d_table full_width d_xs_block m_bottom_15">
						<div class="d_table_cell v_align_m d_xs_block m_xs_bottom_15">
							<h2 class="tt_uppercase color_dark">Single Portfolio Post v2</h2>
						</div>
					...
					<div class="row clearfix">
						<section class="col-lg-8 col-md-8 col-sm-8 m_bottom_50">
							...
							<p class="m_bottom_20">Aenean auctor wisi et urna. Aliquam erat volutpat. Duis ac turpis. Integer rutrum ante eu lacus. Vestibulum libero nisl, porta vel, scelerisque eget, malesuada at, neque. Vivamus eget nibh. Etiam cursus leo vel metus. </p>
							<a href="#" class="color_dark fw_medium d_inline_b m_bottom_20"><i class="fa fa-external-link d_inline_middle m_right_10"></i>Launch Project</a><br>
					...
					<h2 class="tt_uppercase color_dark m_bottom_25">Related Projects</h2>
					<div class="row clearfix">
