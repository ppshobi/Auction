...
<!--[if (gt IE 9)|!(IE)]><!--><html lang="en"><!--<![endif]-->
	<head>
		<title>Flatastic - Category List</title>
		<meta charset="utf-8">
							...
							<div class="row clearfix m_bottom_10">
								...
								<div class="col-lg-5 col-md-4 col-sm-12 t_align_r t_sm_align_l">
									...
									<div class="clearfix d_inline_middle">
										<button class="button_type_7 bg_light_color_1 color_dark tr_delay_hover r_corners mw_0 box_s_none bg_cs_hover f_left"><i class="fa fa-th m_left_0 m_right_0"></i></button>
										...
										<figcaption>
											<div class="clearfix">
												<div class="f_left p_list_description f_sm_none w_sm_full m_xs_bottom_10">
													...
													<p class="d_sm_none d_xs_block">Ut tellus dolor, dapibus eget, elementum vel, cursus eleifend, elit. Aenean auctor wisi et urna. Aliquam erat volutpat. Duis ac turpis. Donec sit amet eros. Lorem ipsum dolor sit amet, consecvtetuer adipiscing elit.</p>
												</div>
										...
										<figcaption>
											<div class="clearfix">
												...
												<div class="f_right t_align_r f_sm_none t_sm_align_l">
													...
													<button class="button_type_4 bg_scheme_color r_corners tr_all_hover color_light mw_0 m_bottom_15">Add to Cart</button><br>
													<ul>
										...
										<figcaption>
											<div class="clearfix">
												...
												<div class="f_right t_align_r f_sm_none t_sm_align_l">
													...
													<button class="button_type_4 bg_scheme_color d_sm_inline_middle m_sm_bottom_0 r_corners tr_all_hover color_light mw_0 m_bottom_15">Add to Cart</button><br class="d_sm_none">
													<button class="button_type_4 bg_light_color_2 d_sm_inline_middle f_sm_none tr_all_hover f_right r_corners color_dark mw_0 m_left_5 p_hr_0"><i class="fa fa-files-o"></i></button>
										...
										<figcaption>
											<div class="clearfix">
												...
												<div class="f_right t_align_r t_sm_align_l f_sm_none">
													<p class="scheme_color f_size_large m_bottom_15"><span class="fw_medium">$102.00</span></p>
													<button class="button_type_4 bg_scheme_color r_corners tr_all_hover color_light mw_0 m_bottom_15 d_sm_inline_middle m_sm_bottom_0">Add to Cart</button><br class="d_sm_none">
													<button class="button_type_4 bg_light_color_2 d_sm_inline_middle f_sm_none tr_all_hover f_right r_corners color_dark mw_0 m_left_5 p_hr_0"><i class="fa fa-files-o"></i></button>
													<button class="button_type_4 bg_light_color_2 d_sm_inline_middle f_sm_none m_sm_left_5 tr_all_hover f_right r_corners color_dark mw_0 p_hr_0"><i class="fa fa-heart-o"></i></button>
												</div>
											</div>
										...
										<figcaption>
											<div class="clearfix">
												...
												<div class="f_right t_align_r f_sm_none t_sm_align_l">
													<p class="scheme_color f_size_large m_bottom_15"><span class="fw_medium">$57.00</span></p>
													<button class="button_type_4 bg_scheme_color r_corners tr_all_hover color_light mw_0 m_bottom_15 m_sm_bottom_0 d_sm_inline_middle">Add to Cart</button><br class="d_sm_none">
													<button class="button_type_4 bg_light_color_2 f_sm_none d_sm_inline_middle tr_all_hover f_right r_corners color_dark mw_0 m_left_5 p_hr_0"><i class="fa fa-files-o"></i></button>
													<button class="button_type_4 bg_light_color_2 f_sm_none d_sm_inline_middle m_left_5 tr_all_hover f_right r_corners color_dark mw_0 p_hr_0"><i class="fa fa-heart-o"></i></button>
												</div>
											</div>
										</figcaption>
									</figure>
