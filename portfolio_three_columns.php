...
<!--[if (gt IE 9)|!(IE)]><!--><html lang="en"><!--<![endif]-->
	<head>
		<title>Flatastic - Portfolio 3 Columns</title>
		<meta charset="utf-8">
			...
			<section class="breadcrumbs">
				<div class="container">
					<ul class="horizontal_list clearfix bc_list f_size_medium">
						...
						<li><a href="#" class="default_t_color">3 Column Portfolio</a></li>
					</ul>
				</div>
			</section>
			<!--content-->
				...
				<div class="container">
					...
					<section class="portfolio_isotope_container three_columns">
						...
						<div class="portfolio_item t_xs_align_c nature">
							<figure class="d_xs_inline_b d_mxs_block">
								<div class="photoframe with_buttons relative shadow r_corners wrapper m_bottom_15">
									<img src="images/portfolio_img_13.jpg" alt="" class="tr_all_long_hover">
									<div class="open_buttons clearfix">
						...
						<div class="portfolio_item t_xs_align_c nature">
							<figure class="d_xs_inline_b d_mxs_block">
								<div class="photoframe with_buttons relative shadow r_corners wrapper m_bottom_15">
									<img src="images/portfolio_img_14.jpg" alt="" class="tr_all_long_hover">
									<div class="open_buttons clearfix">
						...
						<div class="portfolio_item t_xs_align_c cities">
							<figure class="d_xs_inline_b d_mxs_block">
								<div class="photoframe with_buttons relative shadow r_corners wrapper m_bottom_15">
									<img src="images/portfolio_img_15.jpg" alt="" class="tr_all_long_hover">
									<div class="open_buttons clearfix">
